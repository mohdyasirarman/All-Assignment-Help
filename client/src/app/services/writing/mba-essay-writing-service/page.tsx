...
export default function Page() {
  ...
  return (
    <>
      <HeroSectionNew
        changeInH={"Craft Your MBA Essay with Ease"}
        changeInP={"Expert  professional writers to elevate MBA application."}
        isboy={false}
      />
      ...
      <WhatStudentSayAboutUs
        changeInP={"Discover how we’ve helped MBA applicants succeed."}
