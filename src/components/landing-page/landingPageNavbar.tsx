  ...
  return (
    <nav className="sticky shadow-sm mx-[30px] rounded-3xl top-5 z-50 backdrop-filter backdrop-blur-xl ">
      <div className="flex justify-between items-center h-16 max-w-7xl mx-auto">
        ...
        <button className="flex items-center space-x-1 text-black font-semibold px-4 py-[22px] bg-transparent">
          <FaHome />
          <span>Home</span>
        </button>
        {/* Navigation Links */}
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center space-x-1 text-black font-semibold px-4 py-[22px] bg-transparent"
        ...
        <div className="flex items-center space-x-4">
          ...
          <div >
            ...
            <Link
              href="/order"
              className="text-white font-semibold uppercase ml-4 bg-[#2BAFFC] px-[20px] text-center  rounded-3xl py-[10px]  "
            >
              sign up
            </Link>
          </div>
