    ...
    <div className="bg-[#F5F6FB] w-full py-8 my-12">
      <div className="container px-4 py-10 lg:w-[1400px]  mx-auto flex justify-between gap-5 lg:gap-0">
        ...
        <div className="font-poppins pl-10 w-2/4">
          {changeTitle?<><span className=" font-bold font-poppins text-[#000000] text-6xl  block"> {changeTitle}</span></>:<><span className=" font-bold font-inter text-[#0A090F] text-6xl  block">
            Stuck on Your Assignment! <br /> Need Expert Help?
          </span>
          </>}
          {changeInP?<><span className="mt-8 font-normal text-lg text-[#000000dd] block">{changeInP}</span></>:<><span className="mt-8 font-normal text-lg text-[#5F5F5F]  block">
