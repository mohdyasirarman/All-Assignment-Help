...
const unlockExpertHelp = ({changeTitle,changeInP}:imageProps) => {
  return (
    <div>
        ...
        <div className="flex justify-center px-28 text-lg font-dmSans font-bold">
          <div className="flex justify-between items-center bg-[#2C2C2C] p-6 rounded-[16px] w-[936px] h-[241px]">
            ...
            <div className="font-poppins  font-bold leading-[60px] text-left decoration-none">
              {changeTitle?<h1 className="text-[50px]  text-white font-bold ml-[67px] font-poppins  w-[489.42px] h-[51px]">{changeTitle}</h1>:<h1 className="text-[50px] font-bold ml-[67px] font-poppins  w-[489.42px] h-[91px] ">
              ...
              <p className="leading-[27px] ml-[67px] mt-[36.6px] font-poppins w-[387px] h-[30px]">
                {changeInP?<span className="text-[18px] text-[#FFFFFF]">{changeInP}</span>:<><span className="text-[18px] text-[#FFFFFF]">Enjoy</span>{" "}
