...
const UnlockExpertHelp: React.FC = () => {
  return (
    <div className="mt-[200px] relative w-full h-auto">
      ...
      <div className="absolute top-[-190px] left-[50%]  -translate-x-[50%] w-[936px] bg-gradient-to-r from-green-500 to-blue-400 p-10 px-12 rounded-xl text-white flex flex-wrap justify-between items-center mx-auto shadow-xl hover:shadow-2xl transition-all ease-in hover:saturate-150 z-10">
        {/* Text Section */}
