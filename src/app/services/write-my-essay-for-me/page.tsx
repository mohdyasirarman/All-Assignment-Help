...
You can call us or drop a mail to get an essay online service. Our top-notch support agents are available 24/7 to help you with different tasks and bring your academic life right on track.`},
  ...
  return (
    <>
      <AssignmentHelp changeInP={"Say ‘Write My Essay for Me’ to Bridge the Gap between Potential and Achievement"} changeInH={"Professional Write My Essay Service"} changeInForm={"Get instant help from 5000+ experts for"} />
      <BestAssignmentWiter changeInExpertWriteTilte={"Expert Essay Writers at Your Service"} changeInExpertWriteP={"Take a close look at our in-house desk to climb the ladder of academic success today"} />
      <HelpYouNeed changeInYouNeedTitle={"How It Works?"} changeInYouNeedbtn="Order Now" />
      <UnmatchedAcademicSuccess changeInUnmatedTite={"Benefits of Having Us Write an Essay for You"} changeInUnmatedp="Tell us, ‘Write essays for me,’ and unlock these perks along with the perfect solutions" />
      <WhatStudentSayAboutUs changeTitle={"Reviews from Happy Students"} changeInP={"Look at what our valuable clients have to say before you request, “Do my essays for me.”"} />
      <StuckOnAssignment changeTitle={"Join our 1M+ of happy users"} changeInP={"Get original papers written according to your instructions and save time for what matters most."} />
      <AffordablePricing changeTitle={"We Can Write Essays for Any Subject"} changeInP={`Can you write my essay for me on any essay topic?”
Well, MyAssignmentHelp has handpicked eminent professional writers who can precisely craft essays on different subjects.`} />
      ...
      <WritingTool />
      <UnlockExpertHelp  changeTitle = {"5% Cashback"} changeInP={"On APP - grab it while it lasts!"}/>  
      <Footer /> 
    </>
  );
};
